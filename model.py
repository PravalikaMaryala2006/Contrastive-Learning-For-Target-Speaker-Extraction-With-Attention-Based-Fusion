...
# --- Compatibility patch (Windows/SpeechBrain vs torchaudio) ---
# Some torchaudio builds do not expose `set_audio_backend`.
# SpeechBrain calls it during import; if missing, we no-op it.
if not hasattr(torchaudio, "set_audio_backend"):
    def _noop_set_audio_backend(_backend: str):
        return None
